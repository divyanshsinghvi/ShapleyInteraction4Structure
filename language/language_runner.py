...
if __name__  == '__main__':
    ExperimentRunner(cuda=True, seq_len=20, model_name = 'gpt', method=1).run_experiment(suffix='')
    ExperimentRunner(cuda=True, seq_len=20, model_name = 'bert', method=1).run_experiment(suffix='') 
